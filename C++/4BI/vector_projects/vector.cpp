...
public:
    student(string new_surname, string new_name, string new_address, string new_class)
    {
        surname = new_surname;
        name = new_name;
        address = new_address;
    ...
    void return_address(string change_address)
    {
...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
            cout << "Inserire il cognome dello studente che vuole cambiare indirizzo:";
            cin >> search_surname;
